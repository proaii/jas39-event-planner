  ...
  return (
    <div className="flex min-h-full">
      ...
      <Sidebar
        ...
        onNavigateToEvents={() => {}} // No-op since we're already on events
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        ...
        <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => 
                        setProgressFilters(prev => ({ ...prev, notStarted: checked as boolean }))
                      }
                    />
                    <label htmlFor="progress-not-started" className="text-sm text-foreground">Not Started (0%)</label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => 
                        setProgressFilters(prev => ({ ...prev, inProgress: checked as boolean }))
                      }
                    />
                    <label htmlFor="progress-in-progress" className="text-sm text-foreground">In Progress (1-99%)</label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => 
                        setProgressFilters(prev => ({ ...prev, completed: checked as boolean }))
                      }
                    />
                    <label htmlFor="progress-completed" className="text-sm text-foreground">Completed (100%)</label>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => 
                        setDateFilters(prev => ({ ...prev, past: checked as boolean }))
                      }
                    />
                    <label htmlFor="date-past" className="text-sm text-foreground">Past Events</label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="date-week" 
                    ...
                    />
                    <label htmlFor="date-week" className="text-sm text-foreground">This Week</label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="date-month" 
                    ...
                    />
                    <label htmlFor="date-month" className="text-sm text-foreground">This Month</label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="date-upcoming" 
                      ...
                      onCheckedChange={(checked) => 
                        setDateFilters(prev => ({ ...prev, upcoming: checked as boolean }))
                      }
                    />
                    <label htmlFor="date-upcoming" className="text-sm text-foreground">Future Events</label>
                  </div>
                </div>
              </div>
          ...
          {/* Sort Dropdown */}
          <Select value={sortBy} onValueChange={(value: 'date' | 'name' | 'progress') => setSortBy(value)}>
